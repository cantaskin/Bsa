...
namespace Persistence.Migrations
{
    ...
    [Migration("20241026220005_ArtistEntityAddedDemosCollection")]
    partial class ArtistEntityAddedDemosCollection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a643bfc7-38e6-4372-9d35-712d19c6f5b1"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 189, 26, 26, 92, 5, 246, 116, 79, 30, 241, 151, 244, 68, 219, 118, 229, 185, 62, 226, 161, 221, 32, 97, 40, 25, 221, 251, 72, 195, 162, 188, 17, 248, 83, 68, 198, 67, 142, 150, 236, 215, 228, 199, 178, 252, 34, 103, 110, 123, 204, 106, 122, 185, 34, 97, 113, 191, 237, 143, 84, 109, 114, 25, 86 },
                            PasswordSalt = new byte[] { 77, 214, 73, 90, 8, 125, 215, 1, 21, 200, 235, 38, 55, 88, 104, 117, 48, 161, 14, 40, 40, 56, 199, 143, 204, 236, 23, 187, 59, 220, 3, 22, 23, 69, 103, 192, 247, 172, 223, 239, 161, 211, 221, 120, 162, 29, 14, 135, 22, 120, 73, 246, 81, 158, 21, 169, 145, 103, 7, 171, 89, 229, 220, 221, 116, 15, 217, 208, 95, 12, 41, 143, 84, 165, 185, 187, 252, 206, 210, 253, 229, 228, 236, 47, 219, 21, 212, 245, 136, 240, 30, 32, 112, 236, 58, 217, 1, 203, 88, 169, 96, 139, 163, 12, 219, 68, 135, 25, 106, 31, 66, 150, 207, 136, 123, 75, 149, 203, 157, 69, 202, 40, 200, 93, 193, 91, 238, 126 },
                            UserName = ""
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("52ef08dd-c9aa-4258-ae33-fb5259eabaa8"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("a643bfc7-38e6-4372-9d35-712d19c6f5b1")
                        });
                });
